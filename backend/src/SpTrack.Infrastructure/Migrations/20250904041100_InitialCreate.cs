        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MagicLinkTokens_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstResponseMins = table.Column<int>(type: "integer", nullable: false),
                    ResolveMins = table.Column<int>(type: "integer", nullable: false),
                    PauseOnWaitingCustomer = table.Column<bool>(type: "boolean", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketCustomFields_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoles", x => new { x.UserId, x.TenantId, x.Role });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolveDueAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FirstResponseMet = table.Column<bool>(type: "boolean", nullable: false),
                    ResolveMet = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SlaTargets_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketCustomValues", x => new { x.TicketId, x.FieldId });
                    table.ForeignKey(
                        name: "FK_TicketCustomValues_TicketCustomFields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "TicketCustomFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketCustomValues_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AVStatus = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MagicLinkTokens_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlaTargets_TenantId",
                table: "SlaTargets",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SlaTargets_TicketId",
                table: "SlaTargets",
                column: "TicketId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCustomFields_TenantId",
                table: "TicketCustomFields",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketCustomValues_FieldId",
                table: "TicketCustomValues",
                column: "FieldId");
