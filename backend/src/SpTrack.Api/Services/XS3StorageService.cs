...
public class XS3StorageService : XIStorageService
{
    private readonly IAmazonS3 _s3Client;
    private readonly string _bucketName;
    private readonly ILogger<XS3StorageService> _logger;

    public XS3StorageService(IConfiguration configuration, ILogger<XS3StorageService> logger)
    {
