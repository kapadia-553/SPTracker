  ...
  template: `
    <div class="flex flex-col w-64 bg-white shadow-sm">
      <div class="flex items-center justify-center h-16 border-b border-gray-200">
        <div class="text-xl font-bold text-primary-600">SP Track</div>
      </div>
      ...
      <nav class="mt-8 flex-1">
        <div class="px-4 space-y-2">
            ...
            *ngFor="let item of navItems"
            ...
            class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900 border-l-4 border-transparent">
            
            <div class="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500" [innerHTML]="item.icon"></div>
...
export class SidebarComponent {
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>',
      badge: 3
    },
    {
      label: 'Unassigned',
      route: '/tickets?view=unassigned',
